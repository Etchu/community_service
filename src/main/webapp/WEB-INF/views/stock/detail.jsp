...
<body>
    ...
    <div class="content_wrap">
        ...
        <c:if test="${data.pi_owner != userInfo.ui_seq and userInfo.ui_seq != 1}">
       		<div class="post_control">
        		<a href="#" onclick="history.back()" id="post_modify">목록</a>
        	</div>
        </c:if>
        <c:if test="${data.pi_owner == userInfo.ui_seq or userInfo.ui_seq == 1}">
            <div class="post_control">
            	<a href="#" onclick="history.back()" id="post_modify">목록</a>
